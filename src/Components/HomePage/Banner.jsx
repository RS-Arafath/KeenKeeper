            ...
            <div className="relative overflow-hidden rounded-4xl border border-white/70 bg-white/70 px-6 py-12 shadow-[0_24px_80px_rgba(36,77,63,0.08)] backdrop-blur-sm lg:px-16 lg:py-16">
                ...
                <div className="relative space-y-6 py-10">
                    ...
                    <div className="flex flex-col items-center justify-center gap-4 sm:flex-row">
                        <button
                            type="button"
                            className="interactive-button inline-flex cursor-pointer min-h-14 items-center justify-center gap-2 rounded-2xl border border-[#244D3F] bg-[#244D3F] px-7 py-3 text-lg font-semibold text-white shadow-[0_12px_24px_rgba(36,77,63,0.18)] hover:bg-transparent hover:text-[#244D3F]"
                        >
