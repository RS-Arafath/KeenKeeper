        ...
        <div className="container mx-auto flex flex-col items-center gap-6 border-b border-[#1A8862]/20 px-5 pb-10 pt-20 text-center lg:px-0">
          ...
          <div className="flex flex-col items-center gap-4">
            ...
            <div className="flex items-center text-[#101727] gap-4">
              <a
                href=""
                className="interactive-button flex items-center justify-center rounded-full border border-white bg-white shadow-sm hover:bg-yellow-500 hover:text-white transition duration-300"
              >
